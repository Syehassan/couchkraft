...
if (! function_exists('defaultSettings')) {
    ...
    function defaultSettings()
    {
        return [
            ...
            'titleText' => 'Couchkraft',
            'footerText' => '© 2025 COUCHKRAFT. Powered by WorkDo.',
            'themeColor' => 'green',
            'customColor' => '#10b77f',
            ...
            // SEO Settings
            'metaKeywords' => 'ecommerce, online store, shopping, multi-store, saas platform, COUCHKRAFT',
            'metaDescription' => 'Couchkraft - A powerful SaaS platform for creating and managing multiple online stores with professional themes and complete e-commerce features.',
...
if (! function_exists('generateStoreRoutes')) {
    ...
    function generateStoreRoutes($store, $routeName, $parameters = [])
    {
        ...
        $routePaths = [
            ...
            'store.product' => 'product/' . ($parameters['id'] ?? ''),
            ...
            'store.order-detail' => 'my-order/' . ($parameters['orderNumber'] ?? ''),
