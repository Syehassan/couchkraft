...
const appName = import.meta.env.VITE_APP_NAME || 'Couchkraft';
...
createInertiaApp({
    ...
    setup({ el, App, props }) {
        ...
        const globalSettings: any = props.initialPage.props.globalSettings || {};
        ...
        router.on('navigate', (event) => {
            try {
                ...
                const updatedGlobalSettings: any = event.detail.page.props.globalSettings || {};
